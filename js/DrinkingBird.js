...
function createDrinkingBird(bbird) {
  ...
  // brute force instead of traverse
  body.castShadow = body.receiveShadow = true;
  head.castShadow = head.receiveShadow = true;
  support.castShadow = support.receiveShadow = true;
  return; 
  /* the traverse method below triggers many errors, the first one is
  ERROR: 0:135: '' : array size must be a positive integer 
  ERROR: 0:135: '' : array size must be a positive integer 
  ERROR: 0:136: '' : array size must be a positive integer 
  ERROR: 0:136: '' : array size must be a positive integer 
                          three.js:25046
  THREE.js ver 58
  */
